...
export class Tree
{
    lat : number;                   //Latitude of tree      
    long : number;                  //Longitude of tree
    child_tree : DecoratorTree;     //Decorator tree contains collect data methods and will refer to specific assets
    _special_events : string[];     //Contains a list of special events in string format 
    _number_of_events : number;     //Number of speical events
    hidden : boolean;               //Flag used to determine whether or not to display tree on game map
    ...
    // They will then call the specific data collection asset associated with that kind of tree 
